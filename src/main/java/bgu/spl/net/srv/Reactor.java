...
public class Reactor<T> implements Server<T> {
    ...
    private final Supplier<MessageEncoderDecoder<String>> readerFactory; //TODO:check that this is ol to change T to String
    private final ActorThreadPool pool;
    private Selector selector;
    private ConnectionsImpl connections = new ConnectionsImpl();
    private int connectIdcount=0;
    ...
    private void handleAccept(ServerSocketChannel serverChan, Selector selector) throws IOException {
        ...
        final NonBlockingConnectionHandler<String> handler = new NonBlockingConnectionHandler<String>(
                readerFactory.get(),
                protocolFactory.get(),
                clientChan,
                this);
